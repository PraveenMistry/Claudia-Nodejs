A trivial Node.js microservice example, that just returns "Hello World" when called. To try it out, first [set up the credentials](https://claudiajs.com/tutorials/hello-world-lambda.html), then:
